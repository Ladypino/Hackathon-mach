...
const GalleryViews =() =>{
  ...
  return (
   ...
   <div class="column">
    ...
    <a href="/sale-of-the-day"> <img  className="image5" src={image5} /></a>
    </div>

  <div class="column">
  <a href="/gastronomy"> <img  className="image2" src={image2} /></a>
  <a href="/points"> <img  className="image3" src={image3} /></a>
    <img className="image8"  src={image8} />

  </div>

  <div class="column">
  <a href="/shops"> <img  className="image5" src={image7} /></a>
    <a href="/mach-services"> <img  className="image6" src={image6} /></a>
